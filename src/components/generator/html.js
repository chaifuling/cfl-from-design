...
function buildFormTemplate(scheme, child, type) {
  ...
  let str = `<a-form
      ref="${scheme.formRef||'antdFrom'}"
      :model="${scheme.formModel||'antdFrom'}"
...
const layouts = {
  colFormItem(scheme) {
    ...
    let str = `<a-form-item ${labelCol} ${wrapperCol} ${labelAlign} ${label}
...
export function makeUpHtml(formConfig, type) {
  ...
  !confGlobal.formModel&&(confGlobal.formModel='antdFrom')
